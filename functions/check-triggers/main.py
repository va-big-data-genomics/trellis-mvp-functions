...
if __name__ == "__main__":
    ...
    data = {
            ...
            'results': {'node': {'extension': 'json', 'dirname': 'va_mvp_phase2/DVALABP000398/SHIP4946367', 'path': 'va_mvp_phase2/DVALABP000398/SHIP4946367/SHIP4946367.json', 'storageClass': 'REGIONAL', 'md5Hash': 'sLK5JVGK7A9Xbcb4suIA8g==', 'timeCreatedEpoch': 1555361458.597, 'timeUpdatedEpoch': 1556912779.685, 'timeCreated': '2019-04-15T20:50:58.597Z', 'id': '***REMOVED***-dev-from-personalis/va_mvp_phase2/DVALABP000398/SHIP4946367/SHIP4946367.json/1555361458598179', 'contentType': 'application/json', 'generation': '1555361458598179', 'metageneration': '15', 'kind': 'storage#object', 'timeUpdatedIso': '2019-05-03T19:46:19.685000+00:00', 'sample': 'SHIP4946367', 'mediaLink': 'https://www.googleapis.com/download/storage/v1/b/***REMOVED***-dev-from-personalis/o/va_mvp_phase2%2FDVALABP000398%2FSHIP4946367%2FSHIP4946367.json?generation=1555361458598179&alt=media', 'selfLink': 'https://www.googleapis.com/storage/v1/b/***REMOVED***-dev-from-personalis/o/va_mvp_phase2%2FDVALABP000398%2FSHIP4946367%2FSHIP4946367.json', 'labels': ['Json', 'WGS_35000', 'Blob'], 'bucket': '***REMOVED***-dev-from-personalis', 'basename': 'SHIP4946367.json', 'crc32c': '3fotNQ==', 'size': 686, 'timeStorageClassUpdated': '2019-04-15T20:50:58.597Z', 'name': 'SHIP4946367', 'etag': 'CKPi8vn80uECEA8=', 'timeCreatedIso': '2019-04-15T20:50:58.597000+00:00', 'updated': '2019-05-03T19:46:19.685Z'}}}
    data = json.dumps(data).encode('utf-8')
    event = {'data': base64.b64encode(data)}
    context = None
    result = check_triggers(event, context)
