...
mock_context.resource = {
                         ...
                         'name': 'projects/my-gcp-project/topics/delete-blob', 
...
class TestCheckProtectedPatterns:
    ...
    def test_cram(self):
        path = "DVALABP0/SHIP0/gatk-5-dollar/201016-005855-366-0ee9d9a6/output/germline_single_sample_workflow/3fb18586-5ded-4967-8303-30c0bba2cda7/call-ConvertToCram/SHIP0.cram"
    ...
    def test_gvcf(self):
        path = "DVALABP0/SHIP0/gatk-5-dollar/201016-005855-366-0ee9d9a6/output/germline_single_sample_workflow/3fb18586-5ded-4967-8303-30c0bba2cda7/call-MergeVCFs/SHIP0.g.vcf.gz"
...
class TestMain:
    ...
    def test_expected(self):
        data = {
                'body': {
                         'cypher': 'MATCH (s:PersonalisSequencing)-[:GENERATED|WAS_USED_BY|LED_TO*]->(b:Blob) WHERE s.sample = "SHIP0" WITH COLLECT(DISTINCT(b)) AS all_blobs UNWIND all_blobs AS b MATCH p=(b)-[*1..2]-(:BiologicalOme) WHERE ALL (r in relationships(p) WHERE r.ontology="bioinformatics") WITH all_blobs, COLLECT(b) AS essential_blobs UNWIND all_blobs AS b MATCH (b) WHERE NOT b IN essential_blobs AND (NOT b.obj_exists = false OR NOT EXISTS(b.obj_exists)) AND b.bucket = "my-gcp-project-from-personalis-phase3-data" RETURN b.bucket AS bucket, b.path AS path ORDER BY b.size DESC LIMIT 100', 
                         'results': [
                                     {
                                      'bucket': 'my-gcp-project-from-personalis-phase3-data', 
                                      'path': 'DVALABP0/SHIP0/gatk-5-dollar/201016-010047-632-ed170a4a/output/germline_single_sample_workflow/392d181f-d459-4ae9-bda4-3ef528f67286/call-MarkDuplicates/SHIP0.aligned.unsorted.duplicates_marked.bam'
                                     }, 
                                     {
                                      'bucket': 'my-gcp-project-from-personalis-phase3-data', 
                                      'path': 'DVALABP0/SHIP0/gatk-5-dollar/201016-010047-632-ed170a4a/output/germline_single_sample_workflow/392d181f-d459-4ae9-bda4-3ef528f67286/call-SortSampleBam/SHIP0.aligned.duplicate_marked.sorted.bam'
                                     }
                                    ]
                        },
                 'header': {
